  ...
  return (
    <div class="round-shadow-box-form access">
      ...
      <div class="access-form">
        <input
          class="field quiz-slag"
          value={slug}
          type="text"
          placeholder="Put quiz-slug here"
          onChange={handleSlugEntering}
        />
        <div class="creation-buttons">
          <div
            role="button"
            class="access-button clickable round-shadow-box-form"
      ...
      <div class="creation-buttons">
        <div
          role="button"
          class="create-quiz-button clickable round-shadow-box-form"
          onClick={navigateToMaker}
        >
